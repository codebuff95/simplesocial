...
//DeleteFriendship removes entry from table 'friendship' which has userids: userid1,userid2.
//It is used to remove pending friend requests or active friendships.
...
//RemoveFriendHandler handles requests sent to URL: "/removefriend".
...
//AddFriendship creates a new entry in table friendship with usderid1 = userid1 and
//userid2 = userid2 and status = PENDING.
...
//AddFriendHandler handles requests sent to URL: "/addfriend".
...
//AcceptFriendHandler handles requests sent to URL: "/acceptfriend".
